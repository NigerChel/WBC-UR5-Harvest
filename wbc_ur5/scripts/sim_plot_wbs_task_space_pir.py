...
def callback_whole_body(msg):
    ...
    for contact in msg.contacts:
        if contact.name == "wrist_3_joint":  # gripper_link
...
def save_data_to_csv():
    ...
    csv_file_path = '/home/niger/ros_ws/src/wbc_ur5/plots_task_space/sim_gripper_positions_orientations_pir.csv'
...
def plot_data():
    ...
    plt.savefig('/home/niger/ros_ws/src/wbc_ur5/plots_task_space/sim_gripper_position_orientation_pir.png', dpi=300)
    plt.savefig('/home/niger/ros_ws/src/wbc_ur5/plots_task_space/sim_gripper_position_orientation_pir.svg')
...
def main():
    ...
    rospy.sleep(60)  # Adjust sleep time as needed for data collection
